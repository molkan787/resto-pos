...
import PrinterSelector from './components/pre/PrinterSelector.vue';
import PrintersSetup from './components/pre/PrintersSetup.vue';
import CategoryModal from './components/pre/CategoryModal.vue';
